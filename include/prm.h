...
#define PRM_NOTCONVERGED   -201
#define PRM_BADNUMVERTICES -202
#define PRM_ZEROPIVOT      -203
#define PRM_NEGATIVEAREAS  -204
#define PRM_TOLERANCEUNMET -205
#define PRM_NOGLOBALUV     -206
#define PRM_BADPARAM       -207
#define PRM_BADDIVISION    -208
#define PRM_CANNOTFORMLOOP -209
#define PRM_WIGGLEDETECTED -210
#define PRM_INTERNAL       -299
